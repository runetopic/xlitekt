 ...
 * }
 *
 * @see UpdateZonePartialFollowsPacket To send a single update to a zone after clearing it.
 * @see UpdateZonePartialEnclosedPacket To send multiple updates to a zone after clearing it.
 *
