...
fun Application.module() {
    ...
    lazyInject<Network>().awaitOnPort(environment.config.property("ktor.deployment.port").getString().toInt())
}
...
fun Application.addShutdownHook() {
    Runtime.getRuntime().addShutdownHook(
        Thread {
            ...
            lazyInject<Network>().shutdown()
            lazyInject<Game>().shutdown()
        }
    )
}
